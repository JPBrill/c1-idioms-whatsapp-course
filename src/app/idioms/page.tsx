...
const MODULES = [
  ...
  },
  {
    ...
    slug: 'module-03-risk',
    idioms: ['play it by ear', 'go out on a limb', 'throw caution to the wind', 'touch-and-go'],
  },
  {
    week: 4,
    theme: 'Relationships & Conflict',
    slug: 'module-04-relationships',
    idioms: ['hit it off', 'on the same wavelength', 'give someone the cold shoulder', 'in hot water'],
  },
  {
    week: 5,
    theme: 'Time & Planning',
    slug: 'module-05-time',
    idioms: ['last-minute', 'in the long run', 'around the corner', 'call it a day'],
  },
  {
    week: 6,
    theme: 'Thinking & Learning',
    slug: 'module-06-thinking',
    idioms: ['food for thought', 'in two minds', 'hit the nail on the head', 'learn the ropes'],
  },
  {
    week: 7,
    theme: 'Money & Value',
    slug: 'module-07-money',
    idioms: ['cost an arm and a leg', 'bang for your buck', 'tighten your belt', 'in the red'],
  },
  {
    week: 8,
    theme: 'Communication & Honesty',
    slug: 'module-08-communication',
    idioms: ['get straight to the point', 'beat around the bush', 'keep someone in the loop', 'take something with a pinch of salt'],
  },
];
    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-gray-500 max-w-2xl">
          8 thematic modules · 80 idioms. Ten WhatsApp-ready mini-lessons per theme, plus a weekly review challenge.
